...
import com.digitalworld.ecommerce.web.repository.AddressRepository;
import com.digitalworld.ecommerce.web.repository.OrderItemRepository;
...
//        brand 3 => 1 laptop
    ...
    @Override
    public Order findOrderByUser(Long id) throws Exception {
    ...
    public Order cancelOrder(Long orderId, User user) throws Exception {
        Order order = orderRepository.findById(orderId)
                .orElseThrow(() -> new RuntimeException("you don't have access to this order... " + orderId));
