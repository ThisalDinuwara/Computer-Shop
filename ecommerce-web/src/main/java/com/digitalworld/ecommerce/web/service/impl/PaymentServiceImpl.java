...
import com.digitalworld.ecommerce.web.domain.PaymentOrderStatus;
...
import com.digitalworld.ecommerce.web.repository.OrderRepository;
import com.digitalworld.ecommerce.web.repository.PaymentOrderRepository;
import com.digitalworld.ecommerce.web.service.PaymentService;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    // ✅ FIXED: Must be final for @RequiredArgsConstructor injection
                                        ...
                                        SessionCreateParams.LineItem.PriceData.builder()
                                                ...
                                                .setProductData(
                                                        SessionCreateParams
                                                                ...
                                                                .builder()
                                                                .setName("Digital World Computers payment")
                                                                .build()
                                                )
                                                .build()
                                )
