...
const SellerLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 dark:from-dark-950 dark:via-purple-900/20 dark:to-indigo-900/20 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-2xl w-full">
        <div className="card animate-fade-in">
          {/* Header */}
          <div className="text-center mb-8">
            <div className="w-16 h-16 bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-500 dark:to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-purple-500/50 dark:shadow-purple-500/30">
          ...
          {/* Error Message */}
          {error && (
            <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-red-600 dark:text-red-400 text-sm animate-scale-in">
              {error}
            </div>
          )}
          ...
          {/* Success Message */}
          {message && (
            <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg text-green-600 dark:text-green-400 text-sm flex items-center animate-scale-in">
          ...
          {mode === 'login' && step === 'email' && (
            <form onSubmit={handleSendOtp}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 dark:from-purple-500 dark:to-indigo-500 text-white py-3 rounded-xl font-semibold hover:from-purple-700 hover:to-indigo-700 dark:hover:from-purple-600 dark:hover:to-indigo-600 transition-all flex items-center justify-center shadow-lg shadow-purple-500/50 dark:shadow-purple-500/30 transform hover:scale-105 active:scale-95"
              >
                {loading ? (
          ...
          {mode === 'login' && step === 'otp' && (
            <form onSubmit={handleLogin}>
              <div className="mb-6">
                ...
                <div className="relative">
                  <Key className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500" size={20} />
                  <input
                    type="text"
                    value={otp}
              ...
              <button
                ...
                className="w-full mt-3 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
              >
          ...
          {mode === 'register' && (
            <form onSubmit={handleRegister} className="space-y-6">
              ...
              {/* Pickup Address */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Pickup Address</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
        ...
        <div className="text-center mt-6">
          <Link to="/" className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 text-sm transition-colors">
            ← Back to Store
          </Link>
        </div>
      </div>
